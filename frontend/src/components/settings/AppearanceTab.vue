<template>
  <div>
    ...
    <div class="settings-group">
      ...
      <p class="settings-hint tab-placement-hint">
...
.preview-toolbar-move:hover:not(:disabled) {
  background: var(--bg-hover);
}

.preview-toolbar-move:disabled {
  opacity: 0.4;
  cursor: not-allowed;
}
</style>
