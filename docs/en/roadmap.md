...
- Drag-and-drop reordering for file browser and web preview panes
- Keyboard navigation (up/down arrows) for the SSH connection list
- Drag-to-reorder workspaces in Mission Control
